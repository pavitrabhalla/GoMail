...
def _send_email(request):
    ...
    try:
        ...
        content = create_formatted_mime(from_address, subject, body, attachments)
        ...
        #Now try to send email via Sendgrid
        try:
            email_sent = send_email_sendgrid(from_address, to_array, subject, body, attachments)
